...
```{r ch11-1, echo=FALSE, fig.align='center', fig.width=5, fig.cap="Image of American roulette table (with 0 and 00)."}
...
```{r ch11-2, echo=FALSE, fig.width=4.00, fig.height=3.25, fig.cap="Image of the RMS Titanic (damage from iceberg not included)"}
