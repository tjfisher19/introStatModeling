...
Of note here is the number of 0 counts that occur (all first and second class children survived, and there were no children on the crew). This will impact the feasible chose of models we consider in the next chapter.
