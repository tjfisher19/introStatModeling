...
Consider a variation of the two-sample $t$-test we performed in the previous chapter. 
...
The result is significant ($F$ = 14.167, $\textrm{df}_1$ = 2, $\textrm{df}_2$ = 15, $p$-value = 0.00035). Thus, we could conclude that at least two of the drugs produce significantly different mean alertness responses.
...
95\% CI for $\mu_A - \mu_C$ = (0.2521, 0.7702). We can be 95\% confident that drug *A* produces a true log-mean alertness score that is between 0.2521 to 0.7702 higher than drug *C*.
