...
Transforming a response comes with some cost -- we lost some contextual interpretation. 
...
Following the example in Section \@ref(twoFactorAsOneFactor) we refit the model as a One-Way block with the $2\times 2=4$ unique treatments.
