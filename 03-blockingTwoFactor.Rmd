...
Here is the general data structure for a randomized block design (RBD) with on treatment replicate per block:
...
The effect of word type appears quite stark, with positive word recalls being higher than the other two types.
There is also a bit of subject-to-subject variability, but not much.
