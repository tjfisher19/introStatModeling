...
The first chapter reviews introductory statistics material and provides a crash course in the basics of R and making plots with `ggplot2` [@R-ggplot2]. 
Chapters 2, 3 and 4 extend the idea of two-sample inference into the design setting, presenting all inference in the form of a linear model. 
Chapters 5--10 cover the *classic* topics around multiple linear regression. 
...
The data used in this text is available on the hosting website and links are provided throughout the text.
