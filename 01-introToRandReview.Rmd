---
title: "Intro R and Intro Statistics Review"
output: 
  html_document:
    css: style.css
...
```{r}
t.test(act ~ year, data=uadata.trim, conf.level=0.98, alternative="greater")
```

We are 98\% confident that the mean difference between 1996 ACT scores and 2000 ACT scores is in the interval (-0.790, $\infty$). Further, we lack significant evidence (*p*-value$\approx 0.3816$) to conclude that the average ACT score in 1996 is greater than that in 2000 for incoming freshmen. (also note that the value 0 is included in the confidence interval
